...
void GeneratorCSharp::GenerateFBEFieldModel(const std::string &name,
...
void GeneratorCSharp::GenerateFBEFieldModelOptional(bool valueType) {
  ...
  // Prepare code template
  code = std::regex_replace(code, std::regex("_NAME_"),
                            (valueType ? "value type" : "reference type"));
  code = std::regex_replace(code, std::regex("_TYPE_"),
                            (valueType ? "ValueType" : "ReferenceType"));
  code = std::regex_replace(code, std::regex("_BASE_"),
                            (valueType ? "struct" : "class"));
  code =
      std::regex_replace(code, std::regex("_ARGS_"), (valueType ? "T?" : "T"));
  code = std::regex_replace(code, std::regex("_HAS_VALUE_"),
                            (valueType ? ".HasValue" : " != null"));
...
void GeneratorCSharp::GenerateFBEFieldModelArray(bool valueType,
                                                 bool optional) {
  std::string code = R"CODE(
  ...
  code = std::regex_replace(
      code, std::regex("_NAME_"),
      (optional
           ? (valueType ? "optional value type" : "optional reference type")
           : (valueType ? "value type" : "reference type")));
  code = std::regex_replace(
      code, std::regex("_TYPE_"),
      (optional ? (valueType ? "OptionalValueType" : "OptionalReferenceType")
                : (valueType ? "ValueType" : "ReferenceType")));
  code = std::regex_replace(code, std::regex("_BASE_"),
                            (valueType ? "struct" : "class"));
  code = std::regex_replace(code, std::regex("_ARGS_"),
                            ((optional && valueType) ? "T?" : "T"));
  code = std::regex_replace(code, std::regex("_MODEL_CLONE_"),
                            (optional ? "new FieldModelOptional_MODEL_REF_<T, "
                                        "TModel>(model, buffer, offset)"
                                      : "model.Clone() as TModel"));
  code = std::regex_replace(
      code, std::regex("_MODEL_DECL_"),
      (optional ? "FieldModelOptional_MODEL_REF_<T, TModel>" : "TModel"));
  code = std::regex_replace(code, std::regex("_MODEL_REF_"),
                            (valueType ? "ValueType" : "ReferenceType"));
  code = std::regex_replace(code, std::regex("_MODEL_VALUE_"),
                            (optional ? ".Value" : ""));
  code = std::regex_replace(code, std::regex("\n"), EndLine());
...
void GeneratorCSharp::GenerateFBEFieldModelVector(bool valueType,
                                                  bool optional) {
  std::string code = R"CODE(
...
void GeneratorCSharp::GenerateFBEFieldModelMap(bool valueTypeKey,
                                               bool valueTypeValue,
                                               bool optional) {
  std::string code = R"CODE(
  ...
  // Prepare code template
  code = std::regex_replace(
      code, std::regex("_NAME_KEY_"),
      (valueTypeKey ? "value type key" : "reference type key"));
  code = std::regex_replace(
      code, std::regex("_NAME_VALUE_"),
      (optional
           ? (valueTypeValue ? "optional value type value"
                             : "optional reference type value")
           : (valueTypeValue ? "value type value" : "reference type value")));
  code =
      std::regex_replace(code, std::regex("_TYPE_KEY_"),
                         (valueTypeKey ? "ValueTypeKey" : "ReferenceTypeKey"));
  code = std::regex_replace(
      code, std::regex("_TYPE_VALUE_"),
      (optional ? (valueTypeValue ? "OptionalValueTypeValue"
                                  : "OptionalReferenceTypeValue")
                : (valueTypeValue ? "ValueTypeValue" : "ReferenceTypeValue")));
  code = std::regex_replace(code, std::regex("_BASE_KEY_"),
                            (valueTypeKey ? "struct" : "class"));
  code = std::regex_replace(code, std::regex("_BASE_VALUE_"),
                            (valueTypeValue ? "struct" : "class"));
  code = std::regex_replace(code, std::regex("_ARGS_KEY_"), "TKey");
  code =
      std::regex_replace(code, std::regex("_ARGS_VALUE_"),
                         ((optional && valueTypeValue) ? "TValue?" : "TValue"));
  code = std::regex_replace(code, std::regex("_MODEL_KEY_CLONE_"),
                            "modelKey.Clone() as TKeyModel");
  code = std::regex_replace(code, std::regex("_MODEL_KEY_DECL_"), "TKeyModel");
  code = std::regex_replace(code, std::regex("_MODEL_KEY_REF_"),
                            (valueTypeKey ? "ValueType" : "ReferenceType"));
  code = std::regex_replace(code, std::regex("_MODEL_KEY_VALUE_"), "");
  code = std::regex_replace(
      code, std::regex("_MODEL_VALUE_CLONE_"),
      (optional ? "new FieldModelOptional_MODEL_VALUE_REF_<TValue, "
                  "TValueModel>(modelValue, buffer, offset)"
                : "modelValue.Clone() as TValueModel"));
  code = std::regex_replace(
      code, std::regex("_MODEL_VALUE_DECL_"),
      (optional ? "FieldModelOptional_MODEL_VALUE_REF_<TValue, TValueModel>"
                : "TValueModel"));
  code = std::regex_replace(code, std::regex("_MODEL_VALUE_REF_"),
                            (valueTypeValue ? "ValueType" : "ReferenceType"));
  code = std::regex_replace(code, std::regex("_MODEL_VALUE_VALUE_"),
                            (optional ? ".Value" : ""));
  code = std::regex_replace(code, std::regex("\n"), EndLine());
...
void GeneratorCSharp::GenerateFBEFinalModel(const std::string &name,
                                            const std::string &type,
                                            const std::string &base,
                                            const std::string &size,
                                            const std::string &defaults) {
...
void GeneratorCSharp::GenerateFBEFinalModelArray(bool valueType,
                                                 bool optional) {
  std::string code = R"CODE(
  ...
  code = std::regex_replace(code, std::regex("_ARGS_"),
                            ((optional && valueType) ? "T?" : "T"));
  code = std::regex_replace(code, std::regex("_MODEL_CLONE_"),
                            (optional ? "new FinalModelOptional_MODEL_REF_<T, "
                                        "TModel>(model, buffer, offset)"
                                      : "model.Clone() as TModel"));
  code = std::regex_replace(
      code, std::regex("_MODEL_DECL_"),
      (optional ? "FinalModelOptional_MODEL_REF_<T, TModel>" : "TModel"));
  code = std::regex_replace(code, std::regex("_MODEL_REF_"),
                            (valueType ? "ValueType" : "ReferenceType"));
  code = std::regex_replace(code, std::regex("_MODEL_VALUE_"),
                            (optional ? ".Value" : ""));
...
void GeneratorCSharp::GenerateFBEFinalModelVector(bool valueType,
                                                  bool optional) {
  std::string code = R"CODE(
...
void GeneratorCSharp::GenerateFBEFinalModelMap(bool valueTypeKey,
                                               bool valueTypeValue,
                                               bool optional) {
  std::string code = R"CODE(
  ...
  code = std::regex_replace(
      code, std::regex("_MODEL_VALUE_CLONE_"),
      (optional ? "new FinalModelOptional_MODEL_VALUE_REF_<TValue, "
                  "TValueModel>(modelValue, buffer, offset)"
                : "modelValue.Clone() as TValueModel"));
  code = std::regex_replace(
      code, std::regex("_MODEL_VALUE_DECL_"),
      (optional ? "FinalModelOptional_MODEL_VALUE_REF_<TValue, TValueModel>"
                : "TValueModel"));
  code = std::regex_replace(code, std::regex("_MODEL_VALUE_REF_"),
                            (valueTypeValue ? "ValueType" : "ReferenceType"));
  code = std::regex_replace(code, std::regex("_MODEL_VALUE_VALUE_"),
...
void GeneratorCSharp::GenerateEnum(const std::shared_ptr<Package> &p,
  ...
  json = std::regex_replace(json, std::regex("_ENUM_UTF8JSON_TYPE_"),
                            ConvertEnumTypeUtf8Json(enum_type));
  ...
  if (e->body) {
    ...
    for (auto it = e->body->values.begin(); it != e->body->values.end(); ++it) {
      WriteIndent("public const " + enum_base_type + " _" + *(*it)->name +
                  "_ = ");
      if ((*it)->value) {
        ...
        } else if ((*it)->value->reference &&
                   !(*it)->value->reference->empty()) {
          index = 0;
  ...
  if (e->body) {
    for (auto it = e->body->values.begin(); it != e->body->values.end(); ++it)
      WriteLineIndent("public static " + *e->name + " " + *(*it)->name +
                      " = new " + *e->name + "(_" + *(*it)->name + "_);");
    WriteLine();
  }
  ...
  if (e->body && !e->body->values.empty()) {
    for (const auto &value : e->body->values)
      WriteLineIndent("if (this == " + *value->name + ")" + " return \"" +
                      *value->name + "\";");
...
void GeneratorCSharp::GenerateEnumFieldModel(
    const std::shared_ptr<Package> &p, const std::shared_ptr<EnumType> &e) {
  // Generate namespace begin
  WriteLine();
  WriteLineIndent("namespace FBE {");
  WriteLineIndent("namespace " + *p->name + " {");
  ...
  code = std::regex_replace(code, std::regex("_ENUM_NAME_"), *e->name);
  code = std::regex_replace(code, std::regex("_ENUM_TYPE_"), enum_base_type);
  code = std::regex_replace(code, std::regex("_ENUM_SIZE_"),
                            ConvertEnumSize(enum_type));
  code = std::regex_replace(code, std::regex("_ENUM_READ_"),
                            ConvertEnumRead(enum_type));
  code = std::regex_replace(code, std::regex("\n"), EndLine());
...
void GeneratorCSharp::GenerateEnumFinalModel(
    const std::shared_ptr<Package> &p, const std::shared_ptr<EnumType> &e) {
  // Generate namespace begin
  WriteLine();
  WriteLineIndent("namespace FBE {");
...
void GeneratorCSharp::GenerateFlags(const std::shared_ptr<Package> &p,
  ...
  json = std::regex_replace(json, std::regex("_FLAGS_UTF8JSON_TYPE_"),
                            ConvertEnumTypeUtf8Json(flags_type));
  json = std::regex_replace(json, std::regex("\n"), EndLine());
  code = std::regex_replace(code, std::regex("_PACKAGE_"), *p->name);
  ...
  if (f->body) {
    for (auto it = f->body->values.begin(); it != f->body->values.end(); ++it) {
      if ((*it)->value) {
        if ((*it)->value->constant && !(*it)->value->constant->empty())
          WriteLineIndent(
              "public const " + flags_base_type + " _" + *(*it)->name + "_ = " +
              ConvertEnumConstant(flags_type, *(*it)->value->constant) + ";");
        else if ((*it)->value->reference && !(*it)->value->reference->empty())
          WriteLineIndent("public const " + flags_base_type + " _" +
                          *(*it)->name + "_ = _" +
                          ConvertEnumConstant("", *(*it)->value->reference) +
                          "_;");
      }
    }
    WriteLine();
  ...
  if (f->body) {
    for (auto it = f->body->values.begin(); it != f->body->values.end(); ++it)
      if ((*it)->value)
        WriteLineIndent("public static " + *f->name + " " + *(*it)->name +
                        " = new " + *f->name + "(_" + *(*it)->name + "_);");
    WriteLine();
  }
  ...
  if (f->body && !f->body->values.empty()) {
    ...
    for (const auto &value : f->body->values) {
      ...
      WriteLineIndent("{");
      Indent(1);
      WriteLineIndent("sb.Append(first ? \"\" : \"|\").Append(\"" +
                      *value->name + "\");");
...
void GeneratorCSharp::GenerateFlagsFieldModel(
  ...
  code = std::regex_replace(code, std::regex("_FLAGS_NAME_"), *f->name);
  code = std::regex_replace(code, std::regex("_FLAGS_TYPE_"), flags_base_type);
  code = std::regex_replace(code, std::regex("_FLAGS_SIZE_"),
                            ConvertEnumSize(flags_type));
  code = std::regex_replace(code, std::regex("_FLAGS_READ_"),
                            ConvertEnumRead(flags_type));
  code = std::regex_replace(code, std::regex("\n"), EndLine());
...
void GeneratorCSharp::GenerateFlagsFinalModel(
    const std::shared_ptr<Package> &p, const std::shared_ptr<FlagsType> &f) {
  // Generate namespace begin
  WriteLine();
  WriteLineIndent("namespace FBE {");
...
void GeneratorCSharp::GenerateStruct(const std::shared_ptr<Package> &p,
  ...
  WriteLine();
  WriteIndent("public struct " + *s->name + " : IComparable, IComparable<" +
              *s->name + ">, IEquatable<" + *s->name + ">");
  WriteLine();
  WriteLineIndent("{");
  Indent(1);
  ...
  if (s->base && !s->base->empty() && (s->type == 0))
    WriteLineIndent("public const long FBETypeConst = " +
                    ConvertTypeName(*s->base, false) + ".FBETypeConst;");
  else
    WriteLineIndent(
        "public const long FBETypeConst = " + std::to_string(s->type) + ";");
  if (JSON()) {
    WriteLineIndent("#if UTF8JSON");
    WriteLineIndent("[IgnoreDataMember]");
    WriteLineIndent("#else");
  ...
  bool first = true;
  if (s->base && !s->base->empty()) {
    WriteLineIndent(std::string(first ? "" : ", ") + "parent = " +
                    ConvertTypeName(*s->base, false) + ".Default");
    first = false;
  }
  if (s->body) {
    for (const auto &field : s->body->fields) {
  ...
  if ((s->base && !s->base->empty()) || (s->body && !s->body->fields.empty())) {
    ...
    if (s->body) {
      for (const auto &field : s->body->fields) {
        Write(std::string(first ? "" : ", ") + ConvertTypeName(*field) + " " +
              *field->name);
        first = false;
      }
    }
  ...
  WriteLineIndent("var writer = new FBE." + *p->name + "." + *s->name +
                  "Model();");
  WriteLineIndent("writer.Serialize(this);");
  WriteLine();
  WriteLineIndent("// Deserialize the struct from the FBE stream");
  WriteLineIndent("var reader = new FBE." + *p->name + "." + *s->name +
                  "Model();");
  ...
  if (s->body) {
    for (const auto &field : s->body->fields) {
      if (field->keys) {
        WriteLineIndent("result = " + *field->name + ".CompareTo(((" +
                        *s->name + ")other)." + *field->name + ");");
        WriteLineIndent("if (result != 0)");
        Indent(1);
        WriteLineIndent("return result;");
        Indent(-1);
  ...
  if (s->body) {
    for (const auto &field : s->body->fields) {
      if (field->keys) {
        WriteLineIndent("result = " + *field->name + ".CompareTo(other." +
                        *field->name + ");");
        WriteLineIndent("if (result != 0)");
        Indent(1);
        WriteLineIndent("return result;");
  ...
  if (s->body) {
    for (const auto &field : s->body->fields) {
      if (field->keys) {
        WriteLineIndent("if (!" + *field->name + ".Equals(((" + *s->name +
                        ")other)." + *field->name + "))");
        Indent(1);
        WriteLineIndent("return false;");
        Indent(-1);
  ...
  if (s->body) {
    for (const auto &field : s->body->fields) {
      if (field->keys) {
        WriteLineIndent("if (!" + *field->name + ".Equals(other." +
                        *field->name + "))");
        Indent(1);
        WriteLineIndent("return false;");
        Indent(-1);
  ...
  if (s->body)
    for (const auto &field : s->body->fields)
      if (field->keys)
        WriteLineIndent("hash = hash * 31 + " + *field->name +
                        ".GetHashCode();");
  ...
  if (s->body) {
    for (const auto &field : s->body->fields) {
      if (field->attributes && field->attributes->hidden)
        WriteLineIndent("sb.Append(\"" + std::string(first ? "" : ",") +
                        *field->name + "=***\");");
      else if (field->array) {
        ...
        WriteLineIndent("bool first = true;");
        WriteLineIndent("sb.Append(\"" + std::string(first ? "" : ",") +
                        *field->name + "=[\").Append(" + *field->name +
                        ".Length" + ").Append(\"][\");");
        WriteLineIndent("foreach (var item in " + *field->name + ")");
        WriteLineIndent("{");
        Indent(1);
        WriteLineIndent(ConvertOutputStreamValue(*field->type, "item",
                                                 field->optional, true));
        WriteLineIndent("first = false;");
        Indent(-1);
        WriteLineIndent("}");
        ...
        Indent(1);
        WriteLineIndent(
            ConvertOutputStreamValue(*field->key, "item.Key", false, true));
        WriteLineIndent("sb.Append(\"->\");");
        WriteLineIndent(ConvertOutputStreamValue(*field->type, "item.Value",
        ...
        WriteLineIndent("sb.Append(\"" + std::string(first ? "" : ",") +
                        *field->name + "=\"); " +
                        ConvertOutputStreamValue(*field->type, *field->name,
                                                 field->optional, false));
      first = false;
    }
  }
  ...
  if (JSON()) {
    ...
    if (s->base && !s->base->empty()) {
      ...
      WriteLineIndent(
          ...
          "jsonParent.Substring(1, jsonParent.Length - 2) + \"}\";");
    }
    ...
    if (s->base && !s->base->empty())
      WriteLineIndent("result.parent = " + ConvertTypeName(*s->base, false) +
                      ".FromJson(json);");
    WriteLineIndent("return result;");
    Indent(-1);
    WriteLineIndent("}");
  ...
  WriteLine();
  WriteLineIndent(
      "public static FBE.FieldModelValueType<" + *s->name +
      "> CreateFieldModel(FBE.Buffer buffer, long offset) { return new FBE." +
      *p->name + ".FieldModel" + *s->name + "(buffer, offset); }");
...
void GeneratorCSharp::GenerateStructFieldModel(
  ...
  WriteLineIndent("public class FieldModel" + *s->name +
                  " : FieldModelValueType<" + *s->name + ">");
  WriteLineIndent("{");
  Indent(1);

  // Generate struct field model accessors
  if (s->base && !s->base->empty())
    WriteLineIndent("public readonly " + ConvertTypeFieldName(*s->base, false) +
                    " parent;");
  if (s->body)
    for (const auto &field : s->body->fields)
      WriteLineIndent("public readonly " +
                      ConvertTypeFieldDeclaration(*field, false) + " " +
                      *field->name + ";");

  // Generate struct field model constructor
  WriteLine();
  WriteLineIndent("public FieldModel" + *s->name +
                  "(Buffer buffer, long offset) : base(buffer, offset)");
  WriteLineIndent("{");
  Indent(1);
  std::string prev_offset("4");
  std::string prev_size("4");
  if (s->base && !s->base->empty()) {
    WriteLineIndent("parent = new " + ConvertTypeFieldName(*s->base, false) +
                    "(buffer, " + prev_offset + " + " + prev_size + ");");
  ...
  WriteLineIndent("if ((fbeStructOffset == 0) || ((_buffer.Offset + "
                  "fbeStructOffset + 4) > _buffer.Size))");
  Indent(1);
  WriteLineIndent("return 0;");
  Indent(-1);
  WriteLine();
  ...
  if (s->base && !s->base->empty() && (s->type == 0))
    WriteLineIndent("public const long FBETypeConst = " +
                    ConvertTypeFieldName(*s->base, false) + ".FBETypeConst;");
  else
    WriteLineIndent(
        "public const long FBETypeConst = " + std::to_string(s->type) + ";");
  WriteLineIndent("public long FBEType => FBETypeConst;");
  ...
  WriteLineIndent("public override FieldModelValueType<" + *s->name +
                  "> Clone() { return new FieldModel" + *s->name +
                  "(_buffer, _offset); }");
  ...
  WriteLineIndent("uint fbeStructOffset = ReadUInt32(FBEOffset);");
  WriteLineIndent("if ((fbeStructOffset == 0) || ((_buffer.Offset + "
                  "fbeStructOffset + 4 + 4) > _buffer.Size))");
  Indent(1);
  WriteLineIndent("return false;");
  Indent(-1);
  WriteLine();
  ...
  if ((s->base && !s->base->empty()) || (s->body && !s->body->fields.empty())) {
    ...
    if (s->body) {
      for (const auto &field : s->body->fields) {
        WriteLine();
        WriteLineIndent("if ((fbeCurrentSize + " + *field->name +
  ...
  WriteLineIndent("uint fbeStructOffset = ReadUInt32(FBEOffset);");
  WriteLineIndent(
      "Debug.Assert(((fbeStructOffset > 0) && ((_buffer.Offset + "
      "fbeStructOffset + 4 + 4) <= _buffer.Size)), \"Model is broken!\");");
  WriteLineIndent("if ((fbeStructOffset == 0) || ((_buffer.Offset + "
                  "fbeStructOffset + 4 + 4) > _buffer.Size))");
  Indent(1);
  WriteLineIndent("return 0;");
  ...
  WriteLineIndent("public override void Get(out " + *s->name +
                  " fbeValue) { Get(out fbeValue, " + *s->name +
                  ".Default); }");
  WriteLineIndent("public override void Get(out " + *s->name + " fbeValue, " +
                  *s->name + " defaults)");
  WriteLineIndent("{");
  Indent(1);
  ...
  WriteLineIndent("public void GetFields(out " + *s->name +
                  " fbeValue, long fbeStructSize)");
  WriteLineIndent("{");
  Indent(1);
  if ((s->base && !s->base->empty()) || (s->body && !s->body->fields.empty())) {
    WriteLineIndent("long fbeCurrentSize = 4 + 4;");
    ...
    if (s->body) {
      for (const auto &field : s->body->fields) {
        ...
        if (field->array || field->vector || field->list || field->set ||
            field->map || field->hash)
          WriteLineIndent(*field->name + ".Get(ref fbeValue." + *field->name +
                          ");");
        else
          WriteLineIndent(
              *field->name + ".Get(out fbeValue." + *field->name +
              (field->value
        ...
        WriteLineIndent("else");
        Indent(1);
        if (field->vector || field->list || field->set || field->map ||
            field->hash)
          WriteLineIndent("fbeValue." + *field->name + ".Clear();");
        else
          WriteLineIndent("fbeValue." + *field->name + " = " +
                          ConvertDefault(*p->name, *field) + ";");
        Indent(-1);
        WriteLineIndent("fbeCurrentSize += " + *field->name + ".FBESize;");
      }
  ...
  WriteLineIndent("{");
  Indent(1);
  WriteLineIndent("Debug.Assert(((_buffer.Offset + FBEOffset + FBESize) <= "
  ...
  WriteLineIndent("uint fbeStructOffset = "
                  "(uint)(_buffer.Allocate(fbeStructSize) - _buffer.Offset);");
  WriteLineIndent("Debug.Assert(((fbeStructOffset > 0) && ((_buffer.Offset + "
                  "fbeStructOffset + fbeStructSize) <= _buffer.Size)), \"Model "
                  "is broken!\");");
  WriteLineIndent("if ((fbeStructOffset == 0) || ((_buffer.Offset + "
                  "fbeStructOffset + fbeStructSize) > _buffer.Size))");
  Indent(1);
  WriteLineIndent("return 0;");
  Indent(-1);
  WriteLine();
...
void GeneratorCSharp::GenerateStructModel(
    const std::shared_ptr<Package> &p, const std::shared_ptr<StructType> &s) {
  // Generate namespace begin
  WriteLine();
  WriteLineIndent("namespace FBE {");
  ...
  WriteLine();
  WriteLineIndent("public " + *s->name + "Model() { model = new FieldModel" +
                  *s->name + "(Buffer, 4); }");
  WriteLineIndent(
      "public " + *s->name +
      "Model(Buffer buffer) : base(buffer) { model = new FieldModel" +
      *s->name + "(Buffer, 4); }");
  ...
  WriteLineIndent("public const long FBETypeConst = FieldModel" + *s->name +
                  ".FBETypeConst;");
  WriteLineIndent("public long FBEType => FBETypeConst;");
...
void GeneratorCSharp::GenerateStructFinalModel(
    const std::shared_ptr<Package> &p, const std::shared_ptr<StructType> &s) {
  // Generate namespace begin
  WriteLine();
  WriteLineIndent("namespace FBE {");
  ...
  WriteLineIndent("public class FinalModel" + *s->name +
                  " : FinalModelValueType<" + *s->name + ">");
  WriteLineIndent("{");
  Indent(1);

  // Generate struct final model accessors
  if (s->base && !s->base->empty())
    WriteLineIndent("public readonly " + ConvertTypeFieldName(*s->base, true) +
                    " parent;");
  if (s->body)
    for (const auto &field : s->body->fields)
      WriteLineIndent("public readonly " +
  ...
  WriteLine();
  WriteLineIndent("public FinalModel" + *s->name +
                  "(Buffer buffer, long offset) : base(buffer, offset)");
  WriteLineIndent("{");
  Indent(1);
  if (s->base && !s->base->empty())
    WriteLineIndent("parent = new " + ConvertTypeFieldName(*s->base, true) +
                    "(buffer, 0);");
  if (s->body)
    for (const auto &field : s->body->fields)
      WriteLineIndent(*field->name + " = " +
  ...
  WriteLineIndent("public override long FBEAllocationSize(" + *s->name +
                  " fbeValue)");
  WriteLineIndent("{");
  Indent(1);
  ...
  if (s->body)
    for (const auto &field : s->body->fields)
      WriteLineIndent("+ " + *field->name + ".FBEAllocationSize(fbeValue." +
                      *field->name + ")");
  WriteLineIndent(";");
  Indent(-1);
  WriteLineIndent("return fbeResult;");
  ...
  if (s->base && !s->base->empty() && (s->type == 0))
    WriteLineIndent("public const long FBETypeConst = " +
                    ConvertTypeFieldName(*s->base, true) + ".FBETypeConst;");
  else
    WriteLineIndent(
        "public const long FBETypeConst = " + std::to_string(s->type) + ";");
  WriteLineIndent("public long FBEType => FBETypeConst;");
  ...
  WriteLineIndent("public override FinalModelValueType<" + *s->name +
                  "> Clone() { return new FinalModel" + *s->name +
                  "(_buffer, _offset); }");
  ...
  if ((s->base && !s->base->empty()) || (s->body && !s->body->fields.empty())) {
    ...
    if (s->body) {
      for (const auto &field : s->body->fields) {
        WriteLine();
        WriteLineIndent(*field->name + ".FBEOffset = fbeCurrentOffset;");
        WriteLineIndent("fbeFieldSize = " + *field->name +
                        ".Get(out fbeValue." + *field->name + ");");
        WriteLineIndent("fbeCurrentOffset += fbeFieldSize;");
        WriteLineIndent("fbeCurrentSize += fbeFieldSize;");
      }
    }
  ...
  if ((s->base && !s->base->empty()) || (s->body && !s->body->fields.empty())) {
    ...
    if (s->body) {
      for (const auto &field : s->body->fields) {
        WriteLine();
        WriteLineIndent(*field->name + ".FBEOffset = fbeCurrentOffset;");
        WriteLineIndent("fbeFieldSize = " + *field->name + ".Set(fbeValue." +
                        *field->name + ");");
        WriteLineIndent("fbeCurrentOffset += fbeFieldSize;");
        WriteLineIndent("fbeCurrentSize += fbeFieldSize;");
      }
...
void GeneratorCSharp::GenerateStructModelFinal(
    const std::shared_ptr<Package> &p, const std::shared_ptr<StructType> &s) {
  // Generate namespace begin
  WriteLine();
  WriteLineIndent("namespace FBE {");
  ...
  WriteLineIndent("public " + *s->name +
                  "FinalModel() { _model = new FinalModel" + *s->name +
                  "(Buffer, 8); }");
  WriteLineIndent(
      "public " + *s->name +
      "FinalModel(Buffer buffer) : base(buffer) { _model = new FinalModel" +
      *s->name + "(Buffer, 8); }");

  // Generate struct model final FBE properties
  WriteLine();
  WriteLineIndent("// Get the model type");
  WriteLineIndent("public const long FBETypeConst = FinalModel" + *s->name +
                  ".FBETypeConst;");
  WriteLineIndent("public long FBEType => FBETypeConst;");
  ...
  WriteLineIndent("uint fbeStructOffset = "
                  "(uint)(Buffer.Allocate(fbeStructSize) - Buffer.Offset);");
  WriteLineIndent("Debug.Assert(((Buffer.Offset + fbeStructOffset + "
                  "fbeStructSize) <= Buffer.Size), \"Model is broken!\");");
  WriteLineIndent(
  ...
  WriteLineIndent("{");
  Indent(1);
  WriteLineIndent("Debug.Assert(((Buffer.Offset + _model.FBEOffset) <= "
                  "Buffer.Size), \"Model is broken!\");");
  WriteLineIndent("if ((Buffer.Offset + _model.FBEOffset) > Buffer.Size)");
  WriteLineIndent("{");
  Indent(1);
  WriteLineIndent("value = " + *s->name + ".Default;");
  ...
  WriteLineIndent("long fbeStructSize = ReadUInt32(_model.FBEOffset - 8);");
  WriteLineIndent("long fbeStructType = ReadUInt32(_model.FBEOffset - 4);");
  WriteLineIndent("Debug.Assert(((fbeStructSize > 0) && (fbeStructType == "
                  "FBEType)), \"Model is broken!\");");
  WriteLineIndent("if ((fbeStructSize <= 0) || (fbeStructType != FBEType))");
  WriteLineIndent("{");
  Indent(1);
  WriteLineIndent("value = " + *s->name + ".Default;");
...
void GeneratorCSharp::GenerateProtocolVersion(
  ...
  WriteLineIndent(
      "public const int Major = " + std::to_string(p->version->major) + ";");
  WriteLineIndent("// Protocol minor version");
  WriteLineIndent(
      "public const int Minor = " + std::to_string(p->version->minor) + ";");
  Indent(-1);
  WriteLineIndent("}");
...
void GeneratorCSharp::GenerateSender(const std::shared_ptr<Package> &p,
                                     bool final) {
  // Generate namespace begin
  WriteLine();
  WriteLineIndent("namespace FBE {");
  ...
  if (final)
    WriteLineIndent("// Fast Binary Encoding " + *p->name +
                    " final sender listener interface");
  else
    WriteLineIndent("// Fast Binary Encoding " + *p->name +
                    " sender listener interface");
  ...
  if (p->import) {
    ...
    for (const auto &import : p->import->imports)
      WriteLineIndent("public readonly " + *import + "." + sender + " " +
                      *import + "Sender;");
    WriteLine();
  }
  ...
  if (p->body) {
    ...
    for (const auto &s : p->body->structs)
      if (s->message)
        WriteLineIndent("public readonly " + *s->name + model + " " + *s->name +
                        "Model;");
    WriteLine();
  }

  // Generate sender constructors
  WriteLineIndent("public " + sender + "() : base(" +
                  std::string(final ? "true" : "false") + ")");
  WriteLineIndent("{");
  Indent(1);
  if (p->import) {
    for (const auto &import : p->import->imports)
      WriteLineIndent(*import + "Sender = new " + *import + "." + sender +
                      "(Buffer);");
  }
  if (p->body) {
    for (const auto &s : p->body->structs)
  ...
  if (p->body) {
    ...
    for (const auto &s : p->body->structs) {
      if (s->message) {
        ...
        WriteLineIndent("case " + struct_name +
                        " value when value.FBEType == " + struct_name +
                        ".FBETypeConst: return SendListener(listener, value);");
      }
    }
  ...
  if (p->import) {
    ...
    for (const auto &import : p->import->imports) {
      WriteLineIndent("result = " + *import +
                      "Sender.SendListener(listener, obj);");
      WriteLineIndent("if (result > 0)");
      Indent(1);
      WriteLineIndent("return result;");
      Indent(-1);
  ...
  if (p->body) {
    for (const auto &s : p->body->structs) {
      if (s->message) {
        ...
        WriteLineIndent("long serialized = " + *s->name +
                        "Model.Serialize(value);");
        WriteLineIndent("Debug.Assert((serialized > 0), \"" + *p->name + "." +
                        *s->name + " serialization failed!\");");
        WriteLineIndent("Debug.Assert(" + *s->name + "Model.Verify(), \"" +
                        *p->name + "." + *s->name + " validation failed!\");");
        WriteLine();
...
void GeneratorCSharp::GenerateReceiver(const std::shared_ptr<Package> &p,
                                       bool final) {
  // Generate namespace begin
  WriteLine();
  WriteLineIndent("namespace FBE {");
  ...
  if (final)
    WriteLineIndent("// Fast Binary Encoding " + *p->name +
                    " final receiver listener interface");
  else
    WriteLineIndent("// Fast Binary Encoding " + *p->name +
                    " receiver listener interface");
  WriteIndent("public interface " + listener);
  if (p->import) {
    bool first = true;
    Write(" : ");
  ...
  if (p->import) {
    ...
    for (const auto &import : p->import->imports)
      WriteLineIndent("public " + *import + "." + receiver + " " + *import +
                      "Receiver;");
    WriteLine();
  }
  ...
  if (p->body) {
    ...
    for (const auto &s : p->body->structs)
      if (s->message)
        WriteLineIndent("private readonly " + *s->name + model + " " +
                        *s->name + "Model;");
    WriteLine();
  }

  // Generate receiver constructors
  WriteLineIndent("public " + receiver + "() : base(" +
                  std::string(final ? "true" : "false") + ")");
  WriteLineIndent("{");
  Indent(1);
  if (p->import) {
    for (const auto &import : p->import->imports)
      WriteLineIndent(*import + "Receiver = new " + *import + "." + receiver +
                      "(Buffer);");
  }
  if (p->body) {
    for (const auto &s : p->body->structs) {
  ...
  WriteLineIndent("internal override bool OnReceive(long type, byte[] buffer, "
  ...
  if (p->body) {
    ...
    for (const auto &s : p->body->structs) {
      if (s->message) {
        ...
        WriteLineIndent("Debug.Assert(" + *s->name + "Model.Verify(), \"" +
                        *p->name + "." + *s->name + " validation failed!\");");
        WriteLineIndent("long deserialized = " + *s->name +
                        "Model.Deserialize(out " + *s->name + "Value);");
        WriteLineIndent("Debug.Assert((deserialized > 0), \"" + *p->name + "." +
  ...
  if (p->import) {
    for (const auto &import : p->import->imports) {
      WriteLineIndent(
          "if (" + *import +
          "Receiver.OnReceiveListener(listener, type, buffer, offset, size))");
      Indent(1);
      WriteLineIndent("return true;");
      Indent(-1);
    }
...
void GeneratorCSharp::GenerateProxy(const std::shared_ptr<Package> &p,
                                    bool final) {
  // Generate namespace begin
  WriteLine();
  WriteLineIndent("namespace FBE {");
  ...
  if (final)
    WriteLineIndent("// Fast Binary Encoding " + *p->name +
                    " final proxy listener interface");
  else
    WriteLineIndent("// Fast Binary Encoding " + *p->name +
                    " proxy listener interface");
  WriteIndent("public interface " + listener);
  if (p->import) {
    bool first = true;
    Write(" : ");
  ...
  if (p->import) {
    ...
    for (const auto &import : p->import->imports)
      WriteLineIndent("public " + *import + "." + proxy + " " + *import +
                      "Proxy;");
    WriteLine();
  }
  ...
  WriteLineIndent("public " + proxy + "() : base(" +
                  std::string(final ? "true" : "false") + ")");
  WriteLineIndent("{");
  Indent(1);
  if (p->import) {
    for (const auto &import : p->import->imports)
      WriteLineIndent(*import + "Proxy = new " + *import + "." + proxy +
                      "(Buffer);");
  }
  if (p->body) {
    for (const auto &s : p->body->structs)
  ...
  Indent(-1);
  WriteLineIndent("}");
  WriteLineIndent("public " + proxy + "(Buffer buffer) : base(buffer, " +
                  std::string(final ? "true" : "false") + ")");
  WriteLineIndent("{");
  Indent(1);
  if (p->import) {
    ...
    for (const auto &s : p->body->structs) {
      if (s->message) {
        ...
        WriteLineIndent("Debug.Assert(" + *s->name + "Model.Verify(), \"" +
                        *p->name + "." + *s->name + " validation failed!\");");
        WriteLine();
        WriteLineIndent("long fbeBegin = " + *s->name +
                        "Model.model.GetBegin();");
        WriteLineIndent("if (fbeBegin == 0)");
        Indent(1);
        WriteLineIndent("return false;");
        Indent(-1);
        WriteLineIndent("// Call proxy handler");
        WriteLineIndent("listener.OnProxy(" + *s->name +
                        "Model, type, buffer, offset, size);");
  ...
  if (p->import) {
    for (const auto &import : p->import->imports) {
      WriteLineIndent(
          "if (" + *import +
          "Proxy.OnReceiveListener(listener, type, buffer, offset, size))");
      Indent(1);
      WriteLineIndent("return true;");
      Indent(-1);
    }
...
void GeneratorCSharp::GenerateClient(const std::shared_ptr<Package> &p,
                                     bool final) {
  // Generate namespace begin
  WriteLine();
  WriteLineIndent("namespace FBE {");
  ...
  if (final)
    WriteLineIndent("// Fast Binary Encoding " + *p->name +
                    " final client listener interface");
  else
    WriteLineIndent("// Fast Binary Encoding " + *p->name +
  ...
  if (p->import) {
    ...
    for (const auto &import : p->import->imports)
      WriteLineIndent("public readonly " + *import + "." + client + " " +
                      *import + "Client;");
    WriteLine();
  }
  ...
  if (p->body) {
    ...
    for (const auto &s : p->body->structs) {
      if (s->message) {
        std::string struct_name = ConvertTypeName(*p->name, *s->name, false);
        WriteLineIndent("private " + struct_name + " " + *s->name +
                        "ReceiverValue;");
      }
    }
    WriteLine();
    ...
    for (const auto &s : p->body->structs) {
      if (s->message && s->request) {
        std::string response_type =
            (s->response) ? ConvertTypeName(*s->response->response, false) : "";
  ...
  if (!responses.empty()) {
    ...
    for (const auto &response : responses) {
      ...
      WriteLineIndent("private Dictionary<Guid, Tuple<DateTime, TimeSpan, "
                      "TaskCompletionSource<" +
                      response_type + ">>> _requestsById" + response_name +
                      ";");
      WriteLineIndent(
          "private SortedDictionary<DateTime, Guid> _requestsByTimestamp" +
          response_name + ";");
    }
    WriteLine();
  }
  ...
  WriteLineIndent("public " + client + "() : base(" +
                  std::string(final ? "true" : "false") + ")");
  WriteLineIndent("{");
  Indent(1);
  if (p->import)
    for (const auto &import : p->import->imports)
      WriteLineIndent(*import + "Client = new " + *import + "." + client +
                      "(SendBuffer, ReceiveBuffer);");
  if (p->body) {
    for (const auto &s : p->body->structs) {
      if (s->message) {
        std::string struct_name = ConvertTypeName(*p->name, *s->name, false);
        WriteLineIndent(*s->name + "SenderModel = new " + *s->name + model +
                        "(SendBuffer);");
  ...
  if (!responses.empty()) {
    for (const auto &response : responses) {
      ...
      WriteLineIndent("_requestsById" + response_name +
                      " = new Dictionary<Guid, Tuple<DateTime, TimeSpan, "
                      "TaskCompletionSource<" +
                      response_type + ">>>();");
      WriteLineIndent("_requestsByTimestamp" + response_name +
                      " = new SortedDictionary<DateTime, Guid>();");
    }
  }
  Indent(-1);
  WriteLineIndent("}");
  WriteLineIndent("public " + client +
                  "(Buffer sendBuffer, Buffer receiveBuffer) : "
                  "base(sendBuffer, receiveBuffer, " +
                  std::string(final ? "true" : "false") + ")");
  WriteLineIndent("{");
  Indent(1);
  if (p->import)
  ...
  if (p->body) {
    for (const auto &s : p->body->structs) {
      if (s->message && s->request) {
        ...
        WriteLine();
        if (response_type.empty()) {
          WriteLineIndent("public Task Request(" + request_type +
                          " value) { return RequestListener(this, value, "
                          "TimeSpan.Zero); }");
          WriteLineIndent("public Task Request(" + request_type +
                          " value, TimeSpan timeout) { return "
                          "RequestListener(this, value, timeout); }");
          WriteLineIndent("public Task RequestListener(" + listener +
                          " listener, " + request_type +
                          " value) { return RequestListener(listener, value, "
                          "TimeSpan.Zero); }");
          WriteLineIndent("public Task RequestListener(" + listener +
                          " listener, " + request_type +
                          " value, TimeSpan timeout)");
          WriteLineIndent("{");
          Indent(1);
          WriteLineIndent(
          ...
          WriteLineIndent("public Task<" + response_type + "> Request(" +
                          request_type +
                          " value) { return RequestListener(this, value, "
                          "TimeSpan.Zero); }");
          WriteLineIndent("public Task<" + response_type + "> Request(" +
                          ...
                          " value, TimeSpan timeout) { return "
                          "RequestListener(this, value, timeout); }");
          WriteLineIndent("public Task<" + response_type +
                          "> RequestListener(" + listener + " listener, " +
                          request_type +
                          " value) { return RequestListener(listener, value, "
                          "TimeSpan.Zero); }");
          WriteLineIndent("public Task<" + response_type +
                          "> RequestListener(" + listener + " listener, " +
                          request_type + " value, TimeSpan timeout)");
          WriteLineIndent("{");
          Indent(1);
          WriteLineIndent("lock (Lock)");
          WriteLineIndent("{");
          Indent(1);
          WriteLineIndent("TaskCompletionSource<" + response_type +
          ...
          WriteLineIndent("Timestamp = (current <= Timestamp) ? new "
                          "DateTime(Timestamp.Ticks + 1) : current;");
          WriteLine();
          WriteLineIndent("// Register the request");
          WriteLineIndent("_requestsById" + response_field +
                          ".Add(value.id, new Tuple<DateTime, TimeSpan, "
                          "TaskCompletionSource<" +
                          response_type + ">>(Timestamp, timeout, source));");
          WriteLineIndent("if (timeout.Ticks > 0)");
          Indent(1);
          WriteLineIndent("_requestsByTimestamp" + response_field +
                          ".Add(Timestamp, value.id);");
          Indent(-1);
          Indent(-1);
          WriteLineIndent("}");
          WriteLineIndent("else");
  ...
  if (p->import) {
    ...
    for (const auto &import : p->import->imports) {
      WriteLineIndent("result = " + *import +
                      "Client.SendListener(listener, obj);");
      WriteLineIndent("if (result > 0)");
      Indent(1);
      WriteLineIndent("return result;");
      Indent(-1);
  ...
  if (p->body) {
    for (const auto &s : p->body->structs) {
      if (s->message) {
        ...
        WriteLineIndent("// Serialize the value into the FBE stream");
        WriteLineIndent("long serialized = " + *s->name +
                        "SenderModel.Serialize(value);");
        WriteLineIndent("Debug.Assert((serialized > 0), \"" + *p->name + "." +
                        *s->name + " serialization failed!\");");
        WriteLineIndent("Debug.Assert(" + *s->name +
                        "SenderModel.Verify(), \"" + *p->name + "." + *s->name +
                        " validation failed!\");");
        WriteLine();
        WriteLineIndent("// Log the value");
        WriteLineIndent("if (Logging)");
  ...
  for (const auto &response : responses) {
    ...
    WriteLine();
    WriteLineIndent("public bool OnReceiveResponse(" + response_type +
                    " response)");
    WriteLineIndent("{");
    Indent(1);
    WriteLineIndent("ReceivedResponse_" + response_name +
                    "?.Invoke(response);");
    WriteLine();
    if (p->body) {
      ...
      for (const auto &s : p->body->structs) {
        if (s->message && s->response) {
          ...
          std::string struct_response_type =
              ConvertTypeName(*p->name, *s->response->response, false);
          CppCommon::StringUtils::ReplaceAll(struct_response_name, ".", "");

          if ((struct_response_type == response_type) &&
              (cache.find(struct_response_type) == cache.end())) {
            WriteLineIndent("if (_requestsById" + struct_response_name +
                            ".TryGetValue(response.id, out Tuple<DateTime, "
                            "TimeSpan, TaskCompletionSource<" +
                            struct_response_type + ">> tuple))");
            WriteLineIndent("{");
            Indent(1);
            ...
            WriteLineIndent("_requestsById" + struct_response_name +
                            ".Remove(response.id);");
            WriteLineIndent("_requestsByTimestamp" + struct_response_name +
                            ".Remove(timestamp);");
            WriteLineIndent("return true;");
      ...
      if (s->message) {
        ...
        if ((responses.find(*s->name) == responses.end()) &&
          ...
          if (!found)
            WriteLine();
          WriteLineIndent(
              "public bool OnReceiveResponse(" + struct_response_type +
              " response) { ReceivedResponse_" + struct_response_name +
              "?.Invoke(response); return false; }");
          cache.insert(struct_response_type);
          found = true;
        }
      }
      ...
      for (const auto &s : p->body->structs) {
        if (s->message && s->response && s->rejects) {
          for (const auto &r : s->rejects->rejects) {
            ...
            std::string struct_reject_type =
                ConvertTypeName(*p->name, *r.reject, false);
            CppCommon::StringUtils::ReplaceAll(struct_reject_name, ".", "");

            if ((struct_reject_type == reject_type) &&
                (cache.find(struct_response_name) == cache.end())) {
              WriteLineIndent("if (_requestsById" + struct_response_name +
                              ".TryGetValue(reject.id, out Tuple<DateTime, "
                              "TimeSpan, TaskCompletionSource<" +
                              struct_response_type + ">> tuple" +
                              struct_response_name + "))");
              WriteLineIndent("{");
              Indent(1);
              WriteLineIndent("var timestamp = tuple" + struct_response_name +
                              ".Item1;");
              WriteLineIndent("var timespan = tuple" + struct_response_name +
                              ".Item2;");
              WriteLineIndent("var source = tuple" + struct_response_name +
                              ".Item3;");
              WriteLineIndent(
    ...
    for (const auto &s : p->body->structs) {
      if (s->message) {
        ...
        if ((rejects.find(*s->name) == rejects.end()) &&
            (cache.find(struct_reject_type) == cache.end())) {
          if (!found)
            WriteLine();
          WriteLineIndent("public bool OnReceiveReject(" + struct_reject_type +
                          " reject) { ReceivedReject_" + struct_reject_name +
                          "?.Invoke(reject); return false; }");
    ...
    for (const auto &s : p->body->structs) {
      if (s->message) {
        ...
        if (cache.find(struct_notify_type) == cache.end()) {
          if (!found)
            WriteLine();
          WriteLineIndent("public void OnReceiveNotify(" + struct_notify_type +
                          " notify) { ReceivedNotify_" + struct_notify_name +
                          "?.Invoke(notify); }");
    ...
    for (const auto &s : p->body->structs) {
      if (s->message) {
        ...
        if (cache.find(struct_response_type) == cache.end()) {
          if (!found)
            WriteLine();
          WriteLineIndent("public void OnReceive(" + struct_response_type +
                          " value) { if (!OnReceiveResponse(value) && "
  ...
  for (const auto &response : responses) {
    ...
    WriteLine();
    WriteLineIndent("while (_requestsByTimestamp" + response_name +
                    ".Count > 0)");
    WriteLineIndent("{");
    Indent(1);
    WriteLineIndent("var request = _requestsByTimestamp" + response_name +
                    ".First();");
    WriteLineIndent("Tuple<DateTime, TimeSpan, TaskCompletionSource<" +
                    response_type + ">> tuple;");
    WriteLineIndent("_requestsById" + response_name +
                    ".TryGetValue(request.Value, out tuple);");
    WriteLineIndent("var timestamp = tuple.Item1;");
    WriteLineIndent("var timespan = tuple.Item2;");
  ...
  if (p->body) {
    ...
    for (const auto &s : p->body->structs) {
      if (s->message) {
        ...
        WriteLineIndent("Debug.Assert(" + *s->name +
                        "ReceiverModel.Verify(), \"" + *p->name + "." +
                        *s->name + " validation failed!\");");
        WriteLineIndent("long deserialized = " + *s->name +
                        "ReceiverModel.Deserialize(out " + *s->name +
                        "ReceiverValue);");
        WriteLineIndent("Debug.Assert((deserialized > 0), \"" + *p->name + "." +
                        *s->name + " deserialization failed!\");");
        WriteLine();
        ...
        WriteLineIndent("{");
        Indent(1);
        WriteLineIndent("string message = " + *s->name +
  ...
  if (p->import) {
    for (const auto &import : p->import->imports) {
      WriteLineIndent(
          "if (" + *import +
          "Client.OnReceiveListener(listener, type, buffer, offset, size))");
      Indent(1);
      WriteLineIndent("return true;");
      Indent(-1);
    }
  ...
  for (const auto &response : responses) {
    ...
    WriteLineIndent("public delegate void ReceiveResponseHandler_" +
                    response_name + "(" + response_type + " response);");
    WriteLineIndent("public event ReceiveResponseHandler_" + response_name +
                    " ReceivedResponse_" + response_name +
                    " = (response) => {};");
  }
    ...
    for (const auto &s : p->body->structs) {
      if (s->message) {
        ...
        if ((responses.find(*s->name) == responses.end()) &&
            (cache.find(struct_response_type) == cache.end())) {
          WriteLineIndent("public delegate void ReceiveResponseHandler_" +
                          struct_response_name + "(" + struct_response_type +
                          " response);");
          WriteLineIndent("public event ReceiveResponseHandler_" +
                          struct_response_name + " ReceivedResponse_" +
                          struct_response_name + " = (response) => {};");
          cache.insert(struct_response_type);
        }
      }
    }
  ...
  for (const auto &reject : rejects) {
    ...
    WriteLineIndent("public delegate void ReceiveRejectHandler_" + reject_name +
                    "(" + reject_type + " reject);");
    WriteLineIndent("public event ReceiveRejectHandler_" + reject_name +
                    " ReceivedReject_" + reject_name + " = (reject) => {};");
  }
  ...
  if (p->body) {
    ...
    for (const auto &s : p->body->structs) {
      if (s->message) {
        ...
        if ((rejects.find(*s->name) == rejects.end()) &&
            (cache.find(struct_reject_type) == cache.end())) {
          WriteLineIndent("public delegate void ReceiveRejectHandler_" +
                          struct_reject_name + "(" + struct_reject_type +
                          " reject);");
          WriteLineIndent("public event ReceiveRejectHandler_" +
                          struct_reject_name + " ReceivedReject_" +
                          struct_reject_name + " = (reject) => {};");
          cache.insert(struct_reject_type);
        }
      }
    }
  ...
  if (p->body) {
    ...
    for (const auto &s : p->body->structs) {
      if (s->message) {
        ...
        if (cache.find(struct_notify_type) == cache.end()) {
          WriteLineIndent("public delegate void ReceiveNotifyHandler_" +
                          struct_notify_name + "(" + struct_notify_type +
                          " notify);");
          WriteLineIndent("public event ReceiveNotifyHandler_" +
                          struct_notify_name + " ReceivedNotify_" +
...
bool GeneratorCSharp::IsKnownType(const std::string &type) {
  return ((type == "bool") || (type == "byte") || (type == "bytes") ||
          ...
          (type == "decimal") || (type == "string") || (type == "timestamp") ||
          (type == "uuid"));
}
...
std::string GeneratorCSharp::ConvertEnumConstant(const std::string &type,
                                                 const std::string &value) {
  std::string result = value;

  // Fill flags values
  std::vector<std::string> flags =
      CppCommon::StringUtils::Split(result, '|', true);
  ...
  return ConvertEnumConstantPrefix(type) + result +
         ConvertEnumConstantSuffix(type);
}

std::string
GeneratorCSharp::ConvertEnumConstantPrefix(const std::string &type) {
  if (type == "byte")
    return "(byte)";
  else if (type == "char")
    return "(byte)";
...
std::string
GeneratorCSharp::ConvertEnumConstantSuffix(const std::string &type) {
...
std::string GeneratorCSharp::ConvertTypeName(const std::string &type,
                                             bool optional) {
  if (optional) {
    if (type == "bytes")
      return "MemoryStream";
  ...
  std::string ns =
      CppCommon::StringUtils::Contains(type, '.') ? "global::" : "";

  return ns + type;
}

std::string GeneratorCSharp::ConvertTypeName(const std::string &package,
                                             const std::string &type,
                                             bool optional) {
  return (CppCommon::StringUtils::Contains(type, '.')
              ? ""
              : ("global::" + package + ".")) +
         ConvertTypeName(type, optional);
}
...
std::string GeneratorCSharp::ConvertTypeName(const StructField &field) {
  if (field.array)
    ...
    return "SortedDictionary<" + ConvertTypeName(*field.key, false) + ", " +
           ConvertTypeName(*field.type, field.optional) + ">";
  else if (field.hash)
    return "Dictionary<" + ConvertTypeName(*field.key, false) + ", " +
           ConvertTypeName(*field.type, field.optional) + ">";

  return ConvertTypeName(*field.type, field.optional);
}

std::string GeneratorCSharp::ConvertTypeFieldName(const std::string &type,
                                                  bool final) {
...
std::string
GeneratorCSharp::ConvertTypeFieldDeclaration(const StructField &field,
                                             bool final) {
  std::string modelType = final ? "Final" : "Field";

  if (field.array) {
    std::string name =
        IsReferenceType(*field.type) ? "ReferenceType" : "ValueType";
    ...
    return modelType + "ModelArray" + name + "<" +
           ConvertTypeName(*field.type, false) + ", " +
           ConvertTypeFieldDeclaration(value, final) + ">";
    ...
    return modelType + "ModelVector" + name + "<" +
           ConvertTypeName(*field.type, false) + ", " +
           ConvertTypeFieldDeclaration(value, final) + ">";
  } else if (field.map || field.hash) {
    std::string key_name =
        IsReferenceType(*field.key) ? "ReferenceTypeKey" : "ValueTypeKey";
    std::string value_name =
        IsReferenceType(*field.type) ? "ReferenceTypeValue" : "ValueTypeValue";
    ...
    return modelType + "ModelMap" + key_name + value_name + "<" +
           ConvertTypeName(*field.key, false) + ", " +
           ConvertTypeFieldDeclaration(key, final) + ", " +
           ConvertTypeName(*field.type, false) + ", " +
           ConvertTypeFieldDeclaration(value, final) + ">";
    ...
    std::string name =
        IsReferenceType(*field.type) ? "ReferenceType" : "ValueType";
    return modelType + "ModelOptional" + name + "<" +
           ConvertTypeName(*field.type, false) + ", " +
           ConvertTypeFieldDeclaration(value, final) + ">";
...
std::string GeneratorCSharp::ConvertTypeFieldInitialization(
  ...
  if (field.array) {
    ...
    return "new " + modelType + "ModelArray" + name + "<" +
           ConvertTypeName(*field.type, false) + ", " +
           ConvertTypeFieldDeclaration(value, final) + ">(" +
           ConvertTypeFieldInitialization(value, offset, final) + ", buffer, " +
           offset + ", " + std::to_string(field.N) + ")";
  } else if (field.vector || field.list || field.set) {
    std::string name =
        IsReferenceType(*field.type) ? "ReferenceType" : "ValueType";
    ...
    return "new " + modelType + "ModelVector" + name + "<" +
           ConvertTypeName(*field.type, false) + ", " +
           ConvertTypeFieldDeclaration(value, final) + ">(" +
           ConvertTypeFieldInitialization(value, offset, final) + ", buffer, " +
           offset + ")";
    ...
    return "new " + modelType + "ModelMap" + key_name + value_name + "<" +
           ConvertTypeName(*field.key, false) + ", " +
           ConvertTypeFieldDeclaration(key, final) + ", " +
           ConvertTypeName(*field.type, false) + ", " +
           ConvertTypeFieldDeclaration(value, final) + ">(" +
           ConvertTypeFieldInitialization(key, offset, final) + ", " +
           ConvertTypeFieldInitialization(value, offset, final) + ", buffer, " +
           offset + ")";
  } else if (field.optional) {
    std::string name =
    ...
    return "new " + modelType + "ModelOptional" + name + "<" +
           ConvertTypeName(*field.type, false) + ", " +
           ConvertTypeFieldDeclaration(model, final) + ">(" +
           ConvertTypeFieldInitialization(value, offset, final) + ", buffer, " +
           offset + ")";
  } else if (IsKnownType(*field.type)) {
    std::string name =
        IsReferenceType(*field.type) ? "ReferenceType" : "ValueType";
    return modelType + "Model" + name + "<" +
           ConvertTypeName(*field.type, field.optional) + ">.Create" +
           modelType + "Model(BaseTypes." + ConvertBaseTypeName(*field.type) +
           ", buffer, " + offset + ")";
  }

  return "new " + ConvertTypeFieldName(*field.type, final) + "(buffer, " +
         offset + ")";
}

std::string GeneratorCSharp::ConvertConstant(const std::string &type,
                                             const std::string &value,
                                             bool optional) {
  if (value == "true")
    return "true";
  ...
  if (!IsKnownType(type)) {
    ...
    if (flags.size() > 1) {
      ...
      for (const auto &it : flags) {
        std::string flag = CppCommon::StringUtils::ToTrim(it);
        std::string ns =
            (CppCommon::StringUtils::CountAll(flag, ".") > 1) ? "global::" : "";
        result += (first ? "" : " | ") + ns + flag;
        first = false;
      }
    } else {
      std::string ns =
          (CppCommon::StringUtils::CountAll(result, ".") > 1) ? "global::" : "";
      result = ns + result;
    }
  }
...
std::string GeneratorCSharp::ConvertDefault(const std::string &package,
                                            const StructField &field) {
  if (field.value)
    return ConvertConstant(*field.type, *field.value, field.optional);

  if (field.array)
    return "new " + ConvertTypeName(*field.type, field.optional) + "[" +
    ...
    std::string ns = CppCommon::StringUtils::Contains(*field.type, '.')
                         ? ""
                         : ("global::" + package + ".");
...
std::string GeneratorCSharp::ConvertOutputStreamType(const std::string &type,
                                                     const std::string &name,
                                                     bool optional) {
  if (type == "bool")
    return ".Append(" + name + (optional ? ".Value" : "") +
           " ? \"true\" : \"false\")";
  else if (type == "bytes")
    ...
    return ".Append((ulong)((" + name + (optional ? ".Value" : "") +
           ".Ticks - 621355968000000000) * 100))";
  else
    return ".Append(" + name + ")";
}

std::string GeneratorCSharp::ConvertOutputStreamValue(const std::string &type,
                                                      const std::string &name,
                                                      bool optional,
                                                      bool separate) {
  ...
  if (optional || (type == "bytes") || (type == "string"))
    return "if (" + name + " != null) sb" + comma +
           ConvertOutputStreamType(type, name, true) + "; else sb" + comma +
           ".Append(\"null\");";
  else
